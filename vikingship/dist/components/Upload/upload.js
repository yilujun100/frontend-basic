    ...
    return (React.createElement("div", { className: "viking-upload-component" },
        React.createElement("div", { className: "viking-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag ?
                ...
                children,
            React.createElement("input", { className: "viking-file-input", type: "file", ref: fileInput, onChange: handleFileChange, style: { display: 'none' }, accept: accept, multiple: multiple })),
